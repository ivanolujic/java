...
public class Smjer extends Entitet {
	...
	public Boolean isCertificiran() { // kada se deklarira boolena kao klasa
		// (Boolean), a ne kao primitivan tip (boolean), onda se kod getera ne
		// forimira IS, već se kreira GET. Može se promijeniti, da ne dođe
		// do zabune prilikom korištenja getera, ako si naviknut pristupati
		// podacima sa IS
		return certificiran;
	}
