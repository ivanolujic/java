...
public class Grupa extends Entitet {
	...
	private List<Clan> clanovi = new ArrayList<>(); // ovu sintaksu koristimo
	// kako nam se ne bi javlja null exeption prilikom dodavanja novih članova
	// to je svojstvo, pa se rade i geteri i seteri !!
